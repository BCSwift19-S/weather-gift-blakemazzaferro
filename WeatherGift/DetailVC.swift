...
class DetailVC: UIViewController {
    ...
    func updateUserInterface() {
        ...
        let dateString = formatForTimeZone(unixDate: location.currentTime, timeZone: location.timeZone)
    ...
    func formatForTimeZone(unixDate: TimeInterval, timeZone: String) -> String {
